defmodule Crypto.RSAPublicKey do
  @moduledoc false
  ...
  def as_sequence(rsa_public_key) do
    case rsa_public_key do
      ...
      _ ->
        {:error, "invalid Crypto.RSAPublicKey: #{rsa_public_key}"}
    end
  end
  ...
  defimpl Inspect do
    ...
    def inspect(data, _opts) do
      ...
      fp_sha256_parts_doc =
        Crypto.RSAPublicKey.get_fingerprint(data, fp_opts)
        |> String.split(":")
      ...
      glue("#Crypto.RSAPublicKey<", "", fp_sha256_doc)
      |> concat(">")
      |> nest(2)
    end
  end
