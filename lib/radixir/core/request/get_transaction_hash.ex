defmodule Radixir.Core.Request.GetTransactionHash do
  ...
  @doc """
  Generates stitch plan for `network_identifier` map in `GetTransactionHash` request body.
  ...
  @doc """
  Generates stitch plan for `signed_transaction` map in `GetTransactionHash` request body.
