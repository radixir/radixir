defmodule Radixir.Gateway.Request.GetAccountBalances do
  ...
  @doc """
  Generates stitch plan for `network_identifier` map in `GetAccountBalances` request body.
  ...
  @doc """
  Generates stitch plan for `account_identifier` map in `GetAccountBalances` request body.
