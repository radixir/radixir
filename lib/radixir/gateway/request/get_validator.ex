defmodule Radixir.Gateway.Request.GetValidator do
  @moduledoc """
  Methods to create each map in `GetValidator` request body.
  """
  ...
  @doc """
  Generates stitch plan for `network_identifier` map in `GetValidator` request body.
  ...
  @doc """
  Generates stitch plan for `validator_identifier` map in `GetValidator` request body.
  ...
  @doc """
  Generates stitch plan for `at_state_identifier` map in `GetValidator` request body.
