defmodule Radixir.Gateway.Request.DeriveAccountIdentifier do
  @moduledoc """
  Methods to create each map in `DeriveAccountIdentifier` request body.
  """
  ...
  @doc """
  Generates stitch plan for `network_identifier` map in `DeriveAccountIdentifier` request body.
  ...
  @doc """
  Generates stitch plan for `public_key` map in `DeriveAccountIdentifier` request body.
