defmodule Radixir.Gateway.Request.GetUnstakePositions do
  @moduledoc false
  # @moduledoc """
  # Methods to create each map in `GetUnstakePositions` request body.
  # """
  ...
  @doc """
  Generates stitch plan for `network_identifier` map in `GetUnstakePositions` request body.
  ...
  @doc """
  Generates stitch plan for `account_identifier` map in `GetUnstakePositions` request body.
  ...
  @doc """
  Generates stitch plan for `at_state_identifier` map in `GetUnstakePositions` request body.
