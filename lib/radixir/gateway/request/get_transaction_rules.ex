defmodule Radixir.Gateway.Request.GetTransactionRules do
  ...
  @doc """
  Generates stitch plan for `network_identifier` map in `GetTransactionRules` request body.
  ...
  @doc """
  Generates stitch plan for `at_state_identifier` map in `GetTransactionRules` request body.
