defmodule Radixir.Gateway.Request.DeriveValidatorIdentifier do
  @moduledoc false
  # @moduledoc """
  # Methods to create each map in `DeriveValidatorIdentifier` request body.
  # """
  ...
  @doc """
  Generates stitch plan for `network_identifier` map in `DeriveValidatorIdentifier` request body.
  ...
  @doc """
  Generates stitch plan for `public_key` map in `DeriveValidatorIdentifier` request body.
