...
config :radixir, Radixir.Config,
  ...
  radix_admin_username: System.fetch_env!("RADIX_ADMIN_USERNAME"),
  radix_admin_password: System.fetch_env!("RADIX_ADMIN_PASSWORD"),
  radix_superadmin_username: System.fetch_env!("RADIX_SUPERADMIN_USERNAME"),
  radix_superadmin_password: System.fetch_env!("RADIX_SUPERADMIN_PASSWORD"),
  radix_metrics_username: System.fetch_env!("RADIX_METRICS_USERNAME"),
